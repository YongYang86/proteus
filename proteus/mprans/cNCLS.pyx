    ...
    cdef cppclass NCLS_base:
        ...
        double calculateRhsSmoothing(double* mesh_trial_ref,
				      ...
				      double dt, 
			              double lambda_coupez,
			              double beta_coupez)				
        void calculateResidual_development(double* mesh_trial_ref,
                               double* mesh_grad_trial_ref,
                               double* mesh_dof,
...
cdef class cNCLS_base:
   ...
   def calculateRhsSmoothing(self, 
        ...
        return self.thisptr.calculateRhsSmoothing(
				       ...
				       lambda_coupez,
				       beta_coupez)				       
   def calculateResidual_development(self,
                         numpy.ndarray mesh_trial_ref,
                         numpy.ndarray mesh_grad_trial_ref,
                         numpy.ndarray mesh_dof,
			 ...
			 double lambda_coupez, 
			 double beta_coupez):
       self.thisptr.calculateResidual_development(<double*>mesh_trial_ref.data,
                                       <double*>mesh_grad_trial_ref.data,
                                       <double*>mesh_dof.data,
